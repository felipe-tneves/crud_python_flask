...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:Neves132Mysql@localhost/crud'
...
def cria_usuario():
    ...
    #validar se veios os parametros
    ...
    try:
        ...
        print(e)
        return gera_response(400, "usario", {}, "Erro ao cadastrar")
...
def atualiza_usuario(id):
    ...
    try:
        ...
        db.session.commit()
        return gera_response(200, "usario", usuario_objeto.to_json(), "Atualizado com sucesso")
    except Exception as e:
        print("Erro", e)
...
def apaga_usuario(id):
    usuario_objeto = Usuario.query.filter_by(id=id).first()

    try:
        db.session.delete(usuario_objeto)
        db.session.commit()
        return gera_response(200, "usario", usuario_objeto.to_json(), "Deletado com sucesso")
    except Exception as e:
        print("Erro", e)
